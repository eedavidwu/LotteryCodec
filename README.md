...
- **[2025-06-21]** 📝 *Detailed intermediate results (BD-rate vs decoding complexity) are now released on [results](https://github.com/eedavidwu/LotteryCodec/tree/master/results).*
